...
def getSpecHIV():
    ...
    if selected_year == '2015':
        ...
        print('('+ str(child_daly) + "*" + str(child_coverage) + "* (" + str(second_child_distribution) +"*"+ str(second_child_prop) + "*" + str(second_child_eff) + ")\n/1 -" + str(child_coverage) + "* (" + str(second_child_distribution) +"*"+ str(second_child_prop) + "*" + str(second_child_eff) + ")\n=" + str(I_c2))
