...
// import {getForecasts} from './Components/selectors';

import { connect } from 'react-redux';

// import {addForecastRequest} from './Components/thunks';

const dict_data = {};


class Mainmenu extends Component {
  constructor(props, todos, onCreatePressed) {
    super(props);
    this.state = {
  ...
  render(data) {
    // const NewForecastForm = ( {forecasts, onCreatePressed, onCompletedPressed}) => {
